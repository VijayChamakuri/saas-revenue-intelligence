...
| Real Tableau workbook with four checked dashboards and a Tableau Public URL | **Not complete** | Generated `.twbx` opens with no errors; 288 of 288 KPI tie-outs. Pixel QA, screenshots and publication are the manual checkpoint (`docs/tableau_public_release.md`). |
