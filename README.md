...
**Tableau:** [`tableau/workbook/saas_revenue_intelligence.twbx`](tableau/workbook/saas_revenue_intelligence.twbx) is a four-dashboard workbook (Executive overview, Revenue and retention, Customer risk, Finance controls) generated from code with Hyper extracts from the governed marts. It opens in Tableau Public 2026.2.2 with no errors and all 288 KPI values in its extract tie to the marts. **Status: workbook and publication not yet verified; there is no Tableau Public URL yet.** See [`tableau/README.md`](tableau/README.md).
